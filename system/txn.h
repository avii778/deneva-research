...
#include "../concurrency_control/life_types.h"
#include "array.h"
#include "global.h"
#include "helper.h"
#include "semaphore.h"
...
public:
  ...
  void commit_stats(uint64_t thd_id, uint64_t txn_id, uint64_t batch_id,
  ...
  double total_remote_wait_time; // time waiting for a remote response, to help
...
public:
  ...
  access_t get_access_type(uint64_t access_id) {
    return txn->accesses[access_id]->type;
  }
